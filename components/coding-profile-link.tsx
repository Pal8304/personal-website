...
export default function CodingProfileLink({
  ...
  return (
    <Link
      ...
      target="_blank"
      className="p-2 font-roboto border-2 border-slate-700 rounded-md bg-slate-800 hover:bg-slate-700 w-96 h-auto m-4 relative transition-all duration-300 transform hover:scale-110 hover:shadow-2xl hover:border-2 hover:border-gray-50"
    >
